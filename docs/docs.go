...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateModeReq"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/business.BusMode"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
        ...
        "/mode/getModeList": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "分页获取模式列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SearchModeParams"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "分页获取模式列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/mode/modeBindingCategoryWebsites": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "模式绑定分类、网站",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ModeBindingCategoryWebsitesReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateModeReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/website/category/createWebsiteCategory": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateWebsiteCategoryReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/website/category/deleteWebsiteCategory": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/website/category/deleteWebsiteCategorysByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/website/category/getAllWebsiteCategorys": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/business.BusWebsiteCategory"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
        ...
        "/website/category/getWebsiteCategoryById": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/website/category/getWebsiteCategoryList": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "分页获取网站分类列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SearchWebsiteCategoryParams"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "分页获取网站分类列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/website/category/updateWebsiteCategory": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateWebsiteCategoryReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateWebsiteReq"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/business.BusWebsite"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
        ...
        "/website/getWebsiteList": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "分页获取网站列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SearchWebsiteParams"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "分页获取网站列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateWebsiteReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "request.CreateWebsiteCategoryReq": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "request.ModeBindingCategoryWebsitesReq": {
            "type": "object",
            "properties": {
                "category_list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.ModeCategoryWebsitesList"
                    }
                },
                "mode_id": {
                    "type": "integer"
        ...
        "request.ModeCategoryWebsitesList": {
            "type": "object",
            "properties": {
                "category_id": {
                    "type": "integer"
        ...
        "request.SearchWebsiteCategoryParams": {
            "type": "object",
            "properties": {
                "keyword": {
                    "description": "关键字",
        ...
        "request.UpdateWebsiteCategoryReq": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
